...
Shared tokens live in `CONNECT_STYLES` / `src/public/` so landing, future `/status`, and `/docs` can reuse ink/teal + Fraunces/Figtree without inventing a second brand.
